...
/**
 * Boton flotante de WhatsApp, presente en todo el scroll.
 *
 * Es un enlace, no un boton: navega a otro destino, asi que debe poder
 * abrirse en pestana nueva, copiarse y anunciarse como enlace.
 * `bottom` usa safe-area-inset para no quedar bajo la barra de gestos de iOS.
 */
export function WhatsAppFab() {
  return (
    <Link
      ...
      className="fixed right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-transform duration-200 hover:scale-105"
